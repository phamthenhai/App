(function () {
    'use strict'
    angular.module('app')
        .controller('Controller', ['$scope', '$rootScope', '$timeout','$location', function ($scope, $rootScope, $timeout,$location) {
            ...
            var arrAll = [
                ['Nguyen Van Teo', 'Nguyen Thi Men', 'Nguyen Thi Men1', 'Nguyen Thi Men3', 'Nguyen Thi Men2', 'Nguyen Thi Men5'],
                 ['Tran Sach Se', 'Le Thi Cham Chi', 'Tran Sach Se1', 'Le Thi Cham Chi2', 'Tran Sach Se2', 'Le Thi Cham Chi4'],
